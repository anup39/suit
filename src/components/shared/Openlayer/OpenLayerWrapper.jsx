...
function MapWrapper(props) {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      const projectTasks = new VectorLayer({
          source: new VectorSource({features: new GeoJSON().readFeatures(finalGeojson, {
  ...
  const handleMapClick = (event) => {
    ...
    const feature = mapRef.current.forEachFeatureAtPixel(event.pixel, function x(
      featurex,
    ) {
      return featurex;
    });
