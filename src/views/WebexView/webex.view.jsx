  ...
  return (
    <div className={classes.webex_container}>
      ...
      <div className={classes.webex_body}>
        <WebexMeetingsWidget
          accessToken="M2I3NDNjY2ItMWY0Yy00NGFkLTg1MmYtNjc2NzYyNDEyYjAxZTZlZTY3NDYtMDMz_PE93_30b6cf13-6b32-4bf9-9c8f-33eb6c9c44d8" // Substitute with any arbitrary size or use `className`
