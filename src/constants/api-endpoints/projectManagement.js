const PROJECT_MANAGEMENT_API = {
  ...
  PROECT_DOCUMNETS:
  `${process.env.REACT_APP_API_HOSTNAME}api/listProjectsDocuments?projectId=`,
  DASHBORD: `${process.env.REACT_APP_API_HOSTNAME}api/ProjectDashboardList`,
  IMPORT_PROJECT_DATA:
  `${process.env.REACT_APP_API_HOSTNAME}api/auth/importProjectQgis?projectId=`,
  PROJECT_STATUS_DASHBORD:
  `${process.env.REACT_APP_API_HOSTNAME}api/ProjectDashboardStatus`,
